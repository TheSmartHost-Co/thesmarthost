...
export default function SignUpPage() {
  ...
  async function signUp() {
    ...
    if (fullName.trim().length < 2) {
      notify(t('fullNameMinLength'), "error")
      return
    }

    if (!role) {
      notify(t('pleaseSelectRole'), "error")
      return
    }
          ...
          <div className="relative z-10 flex flex-col justify-center px-12 xl:px-16">
            ...
            >
              <h1 className="text-4xl xl:text-5xl font-bold text-white mb-6">
                {t('startAutomating')}
                <br />
                <span className="text-blue-200">{t('propertyReports')}</span>
              </h1>
              <p className="text-blue-100 text-lg mb-10 max-w-md">
                {t('joinPropertyManagers')}
              </p>
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center px-4 sm:px-6 lg:px-12 py-12">
          ...
          >
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900">{t('createYourAccount')}</h2>
              ...
              <form className="space-y-5">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="PROPERTY-MANAGER">{t('rolePropertyManager')}</option>
