  ...
  return (
    <div className="p-6 max-w-3xl mx-auto">
      <div className="flex items-center gap-3 mb-8">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-900">{t('whatsNew')}</h1>
          <p className="text-sm text-gray-500">{t('seeLatestUpdates')}</p>
        </div>
      </div>

      {loading ? (
        <div className="text-center py-8 text-gray-500">{t('loadingUpdates')}</div>
      ) : notes.length === 0 ? (
