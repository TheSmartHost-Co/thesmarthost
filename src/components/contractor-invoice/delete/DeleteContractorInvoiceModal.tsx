...
import { deleteInvoice } from '@/services/contractorInvoiceService'
import type { ContractorInvoice } from '@/services/types/contractorInvoice'
import { useTranslation } from 'react-i18next'
import { useNotificationStore } from '@/store/useNotificationStore'
import { ExclamationTriangleIcon } from '@heroicons/react/24/outline'

interface DeleteContractorInvoiceModalProps {
  isOpen: boolean
  onClose: () => void
...
const DeleteContractorInvoiceModal: React.FC<DeleteContractorInvoiceModalProps> = ({
  isOpen,
  onClose,
  invoice,
  onDeleted,
      ...
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1">
          ...
          {invoice.contractorName && (
            <p className="text-sm text-gray-500 mb-4">Contractor: {invoice.contractorName}</p>
          )}
...
export default DeleteContractorInvoiceModal
