...
import { addInvoiceItem } from '@/services/contractorInvoiceService'
import type { ContractorInvoiceItem } from '@/services/types/contractorInvoice'
...
interface AddExtraChargeModalProps {
  ...
  onClose: () => void
  invoiceId: string
  onAdded: (item: ContractorInvoiceItem) => void
