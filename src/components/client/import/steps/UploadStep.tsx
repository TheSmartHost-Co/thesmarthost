    ...
    <div className="space-y-6">
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
        ...
        <ul className="text-sm text-blue-700 space-y-1">
          ...
          <li>Supported columns: Name, Email, Phone, Status, Company Name</li>
          ...
          <table className="text-xs text-gray-600 font-mono">
            <thead>
              <tr className="border-b border-gray-200">
                <th className="text-left pr-4 py-1">Owner Name</th>
                <th className="text-left pr-4 py-1">Status</th>
                <th className="text-left pr-4 py-1">Email Address</th>
                <th className="text-left pr-4 py-1">Phone Number</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td className="pr-4 py-1">John Doe</td>
                <td className="pr-4 py-1">Active</td>
                <td className="pr-4 py-1">john@example.com</td>
                <td className="pr-4 py-1">123-456-7890</td>
              </tr>
            </tbody>
          </table>
        </div>
