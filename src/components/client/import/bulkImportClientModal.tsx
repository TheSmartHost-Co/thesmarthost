...
interface BulkImportClientModalProps {
  isOpen: boolean
  onClose: () => void
  onImportComplete: (importedClients: Client[]) => void
...
const BulkImportClientModal: React.FC<BulkImportClientModalProps> = ({
  isOpen,
  onClose,
  onImportComplete,
  existingClients,
  ...
  const handleImport = async () => {
    ...
    try {
      ...
      if (response.status === 'success' && response.data) {
        ...
        showNotification(
          `Successfully imported ${summary.imported} clients${summary.skipped > 0 ? `. ${summary.skipped} skipped.` : ''}`,
          'success'
        )
    ...
    <Modal isOpen={isOpen} onClose={onClose} style="w-full max-w-4xl max-h-[90vh]">
      <div className="flex flex-col h-full">
        ...
        <div className="px-6 py-4 border-b border-gray-200">
          ...
          <p className="text-sm text-gray-500 mt-1">Import multiple clients from a CSV file</p>
        </div>
