    ...
    <Modal isOpen={isOpen} onClose={onClose} style="p-6 max-w-4xl w-11/12">
      ...
      {loading ? (
        ...
        <div className="space-y-6">
          {/* Categories list — backend lazy-seeds the canonical defaults
              into expense_categories on first read, so this single table
              shows them alongside any user-created custom categories. */}
          <div>
                    ...
                    {categories.length === 0 && (
                      <tr>
                        <td colSpan={5} className="px-4 py-8 text-center text-gray-500">
                          No categories yet. Defaults will appear automatically on next reload.
                        </td>
                      </tr>
                    )}
                  </tbody>
