...
const Footer: FC = () => {
  ...
  const socialLinks = [
    {
      label: 'Twitter',
      href: 'https://twitter.com/thesmarthost',
      icon: (
    ...
    {
      label: 'LinkedIn',
      href: 'https://linkedin.com/company/thesmarthost',
      icon: (
        <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex items-center gap-3">
              {socialLinks.map((social) => (
                <motion.a
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="w-10 h-10 rounded-xl bg-white border border-gray-200 flex items-center justify-center text-gray-500 hover:text-blue-600 hover:border-blue-200 hover:bg-blue-50 transition-colors shadow-sm"
        ...
        <div className="py-6 border-t border-gray-200 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6">
            <a
              href="mailto:support@thesmarthost.com"
              className="text-gray-500 hover:text-blue-600 text-sm transition-colors flex items-center gap-2"
            >
