  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const payload: CreateBookingPayload = {
        ...
        numNights: parsedNumNights,
        platform,
        listingName: trimmedListingName || undefined,
        nightlyRate: parseOptionalNumber(nightlyRate),
        extraGuestFees: parseOptionalNumber(extraGuestFees),
        cleaningFee: parseOptionalNumber(cleaningFee),
        lodgingTax: parseOptionalNumber(lodgingTax),
        bedLinenFee: parseOptionalNumber(bedLinenFee),
        gst: parseOptionalNumber(gst),
        qst: parseOptionalNumber(qst),
        channelFee: parseOptionalNumber(channelFee),
        stripeFee: parseOptionalNumber(stripeFee),
        totalPayout: parseOptionalNumber(totalPayout),
