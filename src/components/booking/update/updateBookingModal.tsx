  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const payload: UpdateBookingPayload = {
        ...
        platform,
        nightlyRate: parseCurrency(nightlyRate),
        extraGuestFees: parseCurrency(extraGuestFees),
        cleaningFee: parseCurrency(cleaningFee),
        lodgingTax: parseCurrency(lodgingTax),
        bedLinenFee: parseCurrency(bedLinenFee),
        gst: parseCurrency(gst),
        qst: parseCurrency(qst),
        channelFee: parseCurrency(channelFee),
        stripeFee: parseCurrency(stripeFee),
        salesTax: parseCurrency(salesTax),
