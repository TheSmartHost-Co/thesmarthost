...
export const ClientMetricsGrid: React.FC<ClientMetricsGridProps> = ({ stats }) => {
  const metrics = [
    ...
    },
    {
      ...
      subtitle: formatDelta(stats.bookingsThisMonth, stats.bookingsLastMonth),
    ...
    },
    {
      ...
      subtitle: formatDelta(stats.revenueThisMonth, stats.revenueLastMonth, true),
    ...
    },
    {
      ...
      value: stats.activeCleaningProjects,
    ...
    },
    {
      ...
      subtitle: `${stats.totalNights.toLocaleString()} total nights`,
      bgColor: 'bg-teal-50',
      iconBg: 'bg-teal-100',
