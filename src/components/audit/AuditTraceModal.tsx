  ...
  return (
    <li>
      <div
        ...
        className={`flex items-baseline gap-2 py-1 px-2 rounded text-sm ${
          isHighlight ? 'bg-yellow-50 border border-yellow-200' : 'hover:bg-gray-50'
        }`}
      >
    ...
    <table className="w-full text-sm">
      ...
      <tbody>
        {events.map(e => (
          <tr
            key={e.id}
            className={`border-b border-gray-100 ${highlightId === e.id ? 'bg-yellow-50' : ''}`}
          >
